        ...
        <div className='container px-6 py-6 lg:py-12 mx-auto'>
            ...
            <div class="relative bg-white  p-6 ">
                <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2  lg:items-center">
                    <div class="lg:col-start-2 w-full max-w-2xl">
                    ...
                    <div class="mt-4 h-full max-w-lg">
                        <img src="https://img.freepik.com/free-vector/blogging-illustration-concept_114360-788.jpg?size=626&ext=jpg&ga=GA1.2.1239272833.1664376337&semt=sph" alt="illustration" class="relative mx-auto shadow-lg rounded h-screen w-auto" />
                    </div>
                </div>
            </div>
