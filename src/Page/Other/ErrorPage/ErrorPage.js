        ...
        <section className="px-4 py-24 mx-auto max-w-7xl">
            <div className="grid items-center w-full grid-cols-1 gap-10 mx-auto md:w-4/5 lg:grid-cols-2 xl:gap-32">
                <div>
                    ...
                    <Link to="/" className="w-full mb-2 btn btn-lg btn-light sm:w-auto sm:mb-0">Back to homepage</Link>
                    <Link to="/" className="w-full mb-2 btn btn-lg ml-6 btn-outline sm:w-auto sm:mb-0">Contact us</Link>
                </div>
                <div>
