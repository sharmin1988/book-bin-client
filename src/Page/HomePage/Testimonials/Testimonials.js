    ...
    <div class="relative flex">
        ...
        <div
            ...
            <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl  dark:text-white">
                What our <span class="text-fuchsia-700">customers</span> <br/> are saying
            </h1>

            <div class="mt-10 lg:mt-20 lg:flex lg:items-center">
                <img class="object-cover object-center w-full lg:w-[32rem] rounded-lg h-96" src="https://img.freepik.com/free-photo/side-view-pleased-brunette-woman-eyeglasses-sitting-bench-reading-book-park_231208-8081.jpg?size=626&ext=jpg&ga=GA1.2.1239272833.1664376337&semt=sph" alt=""/>
                ...
                <div class="mt-8 lg:px-10 lg:mt-0">
                    ...
                    <h3 class="mt-6 text-lg font-medium text-blue-500">Ronika Ederson</h3>
                    <p class="text-gray-600 dark:text-gray-300">Marketing student at Stech</p>
                </div>
            </div>
